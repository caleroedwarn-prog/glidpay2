export default function Features(){
   return(
    ...
    <div className="Features-header">
        <h1>Features</h1>
        <pre>Powerful Financial FeatturesBuilt for the Modern World
    ...
    <div className="features">
        ...
        <div className="feature">
            ...
            <p>Store and manage multple currencies in one secure wallet without needing multiple bank accounts</p>
